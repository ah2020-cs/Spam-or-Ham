...
def lambda_handler(event, context):
    ...
    #key ='03q17li5cvh8q6dutd2rk0u3iprj6jg14ddcjto1'
    s3 = boto3.resource('s3')
    obj = s3.Object('nyu-assignment-3-emailbucket',key)
